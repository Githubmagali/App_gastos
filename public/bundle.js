...
const contenedorGastos$1 = document.querySelector('#gastosE .gastos__lista'); //linea29 formulario
...
const cargarGastos =()=>{
    ...
    if(gastos && gastos.length > 0){
        ...
        //filter no va a permitir que solo se visualicen los gastos del mes actual
const gastoFilter = gastos.filter((gasto) =>{
    //usamos parseISO para transformarlo la cadena de texto en un objeto porque lo pide la libreria
    ...
    return gasto;
      ...
      gastoFilter.forEach((gasto) => {
         const precio= formatoMoneda.format(gasto.precio);
        //Para no sobreescribir el codigo trabajo con el operador suma y le digo, quiero que tomes todo el contenido
        //que a tenias y queremos argegarle despues de ese codigo todo el codigo que ya teniamos
         contenedorGastos$1.innerHTML +=
         `
        ...
        contenedorGastos$1.innerHTML = '';
        document.querySelector('#gastosE .gastos__mensaje').classList.add('gastos__mensaje--active');
